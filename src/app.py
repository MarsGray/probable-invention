...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive team training and league play",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "noah@mergington.edu"]
    },
    "Yoga Club": {
        "description": "Relaxation, flexibility, and mindfulness practice",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and theatre rehearsals",
    ...
    "Debate Team": {
        "description": "Build research, public speaking, and argument skills",
